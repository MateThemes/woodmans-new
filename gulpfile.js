...
const paths = {
    ...
    dev: {
        base: './woodmansdev/',
        css: './woodmansdev/css',
        html: './woodmansdev/html',
        assets: './woodmansdev/assets',
        img: './woodmansdev/assets/img',
        vendor: './woodmansdev/vendor'
    },
    base: {
        base: './',
        node: './node_modules'
...
gulp.task('scss', function () {
    return gulp.src([paths.src.scss + '/theme/**/*.scss', paths.src.scss + '/styles.scss'])
        .pipe(wait(500))
...
gulp.task('serve', gulp.series('scss', 'html', 'index', 'assets', 'vendor', function () {
    ...
    gulp.watch([paths.src.scss + '/theme/**/*.scss', paths.src.scss + '/styles.scss'], gulp.series('scss'));
